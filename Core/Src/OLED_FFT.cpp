...
//		else if(Temp<4) Temp = 4;
		...
		oled.Draw_Line(3*i,flow_pot[i]+1,3*i,SSD1351_HEIGHT*2/3-1);
		oled.Draw_Line(3*i+1,flow_pot[i]+1,3*i+1,SSD1351_HEIGHT*2/3-1);
...
//	uint16_t i = 0; 
	...
	for(i = 0; i < 60; i++)	
	{
		...
		if(Device_Msg.fft[Index]<100)
			Temp = Rr/2 - (u16)(Device_Msg.fft[Index]/32);
		else if(Device_Msg.fft[Index]>200)
			Temp = Rr/2 - (u16)(Device_Msg.fft[Index]/24);
		else
			Temp = Rr/2 - (u16)(Device_Msg.fft[Index]/8);
		if(Temp < 2)
			Temp = 0;
...
//			SampPoint[0][i*2+1] = OCY;
		...
		oled.Draw_Line(SampPoint[0][i*2]+SSD1351_WIDTH/2,SampPoint[0][i*2+1],SampPoint[1][i*2]+SSD1351_WIDTH/2,SampPoint[1][i*2+1],color_half);
	}
	...
	oled.Draw_Line(SampPoint[0][0*2]+SSD1351_WIDTH/2,SampPoint[0][0*2+1],SampPoint[0][59*2]+SSD1351_WIDTH/2,SampPoint[0][59*2+1]);
	oled.Draw_Line(SampPoint[1][0*2]+SSD1351_WIDTH/2,SampPoint[1][0*2+1],SampPoint[1][59*2]+SSD1351_WIDTH/2,SampPoint[1][59*2+1]);
	
	for(i = 0; i < 60; i++)	
	{
		SampPoint[0][i*2]+=SSD1351_WIDTH/2;
		SampPoint[1][i*2]+=SSD1351_WIDTH/2;
	}
	oled.Draw_LineS(SampPoint[0],60);
	oled.Draw_LineS(SampPoint[1],60);
	runCount++;
...
//	oled.Draw_Circle(OCX,OCY,40-MaxType+20+3,color_min);
	...
	oled.Draw_Line(OCX+(Temp*cos((runCount1+0)*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin((runCount1+0)*6*PI/180)),OCX+(Temp*cos((runCount1+5)*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin((runCount1+5)*6*PI/180)),color_half);
	oled.Draw_Line(OCX+(Temp*cos((runCount1+20)*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin((runCount1+20)*6*PI/180)),OCX+(Temp*cos((runCount1+25)*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin((runCount1+25)*6*PI/180)),color_half);
	oled.Draw_Line(OCX+(Temp*cos((runCount1+40)*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin((runCount1+40)*6*PI/180)),OCX+(Temp*cos((runCount1+45)*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin((runCount1+45)*6*PI/180)),color_half);
...
//	oled.Fill_Circle(OCX,OCY,40+MaxType-20-4);
	...
	oled.Draw_Triangle(OCX+(Temp*cos(runCount*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin(runCount*6*PI/180)),OCX+(Temp*cos((runCount+20)*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin((runCount+20)*6*PI/180)),OCX+(Temp*cos((runCount+40)*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin((runCount+40)*6*PI/180)),color_half);
	Temp-=4;
	...
	oled.Draw_Triangle(OCX+(Temp*cos(runCount*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin(runCount*6*PI/180)),OCX+(Temp*cos((runCount+20)*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin((runCount+20)*6*PI/180)),OCX+(Temp*cos((runCount+40)*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin((runCount+40)*6*PI/180)),0xffff);
//HAL_Delay(100);
}
...
//			SampPoint[0][i*2+1] = OCY;
		...
		oled.Draw_Line(SampPoint[0][i*2]+SSD1351_WIDTH/2,SampPoint[0][i*2+1],SampPoint[1][i*2]+SSD1351_WIDTH/2,SampPoint[1][i*2+1],0xffff);
	}
	for(i = 0; i < 60; i++)	
	{
...
//	oled.Fill_Circle(OCX,OCY,40+MaxType-20-4);
	...
	oled.Draw_Triangle(OCX+(Temp*cos(runCount*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin(runCount*6*PI/180)),OCX+(Temp*cos((runCount+20)*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin((runCount+20)*6*PI/180)),OCX+(Temp*cos((runCount+40)*6*PI/180))+SSD1351_WIDTH/2,OCY+(Temp*sin((runCount+40)*6*PI/180)),color_min);
//HAL_Delay(100);
}
